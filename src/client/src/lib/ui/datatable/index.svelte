    ...
    <div class="alert alert-primary p-card rounded-0 border-0">
        <div class="d-flex align-items-center flex-lg-row flex-column">
            ...
            <div class="btn-group">
                ...
                <button class="btn" on:click={() => onPaginate("next")}>
                    Next
                </button>
                <button class="btn" on:click={() => onPaginate("last")}>
                    Last
                </button>
            </div>
        </div>
                    ...
                    <td>
                        ...
                        >
                            <div
                                ...
                                title={`${
                                    checkedAll ? "diselect all" : "select all"
                                } `}
                            >
                                <input
                                    type="checkbox"
            ...
            <tbody>
                ...
                {#key mutableValues}
                    ...
                    {#await paginate(mutableValues, width) then data}
                        ...
                        {#if data.length < 1}
                            <tr>
                                <td colspan={columns.length}> No Item </td>
                            </tr>
                        {:else}
